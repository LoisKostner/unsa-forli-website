...
> Percorso "Continue": Home → Who we are → What we do → Our structure → News → Contact → Get involved. La pagina What we do elenca le 5 attività (MUN Club, MUN Conference, Talks & Seminars, Community, The Critical Lens). Le pagine di approfondimento (MUN Club, MUN Conference, Panels, Seminars & Workshops, The Critical Lens) sono isolate: si aprono solo da What we do e l'unica uscita è "Back to What we do". Anche le pagine di dettaglio delle news aperte dalla Home sono isolate e riportano solo alla Home.
